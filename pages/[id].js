      ...
      <main className="max-w-4xl mx-auto p-8">
        ...
        >
          ...
          <div className="flex items-center gap-4 mb-6">
            <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-pink-500 flex items-center justify-center rounded-xl shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div className="flex items-center gap-2">
              ...
              <span>Release Date: <b>{track.releaseDate}</b></span>
            </div>
            <div className="flex items-center gap-2">
              <Clock className="w-5 h-5 text-pink-400" />
              <span>Duration: <b>{track.duration || "N/A"}</b></span>
            </div>
            <div className="flex items-center gap-2">
              <Eye className="w-5 h-5 text-blue-400" />
              <span>Plays: <b>{track.plays || "0"}</b></span>
            </div>
            <div className="flex items-center gap-2">
              <Heart className="w-5 h-5 text-red-400" />
              <span>Likes: <b>{track.likes || "0"}</b></span>
            </div>
          </div>
